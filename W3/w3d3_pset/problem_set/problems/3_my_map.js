...
function myMap(arr, cb) {
  ...
  for(let i = 0; i < arr.length; i++){ // looping thru arr
    let ele = arr[i]; // setting it to a var

    newArr.push(cb(ele)); // using the cb func on ele and pushing the new ele to newArr
  }
  return newArr;
}
